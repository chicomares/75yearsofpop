...
// Render the chart
	...
	focus.append("text").attr("class", "focus artist").attr("x", 10).attr("y", 7);
	focus.append("text").attr("class", "focus track").attr("x", 11).attr("y", 7);    
        // Focus line
        ...
        function mousemove() {
			...
			focus.select(".focus.artist").text("Arrtist: " + +d.artist);
